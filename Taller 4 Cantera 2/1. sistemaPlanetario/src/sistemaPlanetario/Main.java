...
public class Main {
	...
	public static void main(String[] args) {
		...
		/**
		 * Instancia de la clase AttractionForce para llamar el método que deermina la
		 * fuerza de atracción
		 * 
		 */
		...
		/**
		 * Método gravitationalAttraction: Utilizado para determinar la fuerza de
		 * atracción de dos planetas
		 * 
