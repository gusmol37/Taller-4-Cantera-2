...
public class BubbleQuickSort implements Methods {
	...
	/**
	 * Método bubbleSortMehod: Realiza el recorrido del arreglo comparando los elementos y realizando su ordenamiento.
	...
	/**
	 * Metodo QuickSort: Método que divide el arreglo y
	 * posteriormete va comparando con el lado derecho o izquierdo para organizar los elementos del arreglo.
	 * @param array : Arreglo
