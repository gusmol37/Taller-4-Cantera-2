...
/**
 * Clase principal que contiene el menú y métodos.
 * 
 */
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * Array : Para llamar el arreglo y sus métodos. BubbleQuickSort : Llamada al
		 * método bubbleSort y quickSort
		 */
		...
		/**
		 * Método que permite imprimir el menú
		 */
		System.out.println("--------------------------------------------- ");
		...
		/**
		 * Try-Catch: Se usa para controlar el ingreso de solo valores númericos. Sirve
		 * para el control de exepciones.
		 */
		try {
			...
			/**
			 * Metodo BubbleSort : Instanciación de la clase BubbleSort con llamada del
			 * método bubbleSortMehod
			 */
			case 1:
